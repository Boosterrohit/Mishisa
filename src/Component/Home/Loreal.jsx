...
function SamplePrevArrow({ onClick }) {
  return (
    <div className="relative">
      <div
        className="arrwo arrow-left bg-white sm:w-16 sm:h-16 h-8 w-8 flex justify-center items-center rounded-full -left-1 absolute z-10 shadow-md lg:top-[167px] top-[212px] md:top-[220px] sm:top-[203px]"
        onClick={onClick}
      >
