...
function SampleNextArrow({ onClick }) {
  return (
    <div className="relative">
      <div
        className="arrwo arrow-right  bg-white sm:w-16 sm:h-16 h-8 w-8 flex justify-center items-center rounded-full  -right-1  shadow-md absolute lg:bottom-44 bottom-[190px] sm:bottom-[190px] md:bottom-[165px]"
        onClick={onClick}
      >
