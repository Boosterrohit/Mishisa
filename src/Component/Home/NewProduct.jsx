...
import { newProduct } from "../../data.js";
...
function SampleNextArrow({ onClick }) {
  return (
    <div className="relative">
      <div
        className="arrwo arrow-right  bg-white sm:w-16 sm:h-16 h-8 w-8 flex justify-center items-center rounded-full  -right-1  shadow-md absolute lg:bottom-44 bottom-[190px] sm:bottom-[190px] md:bottom-[185px]"
        onClick={onClick}
      >
...
function SamplePrevArrow({ onClick }) {
  return (
    <div className="relative">
      <div
        className="arrwo arrow-left bg-white sm:w-16 sm:h-16 h-8 w-8 flex justify-center items-center rounded-full -left-1 absolute z-10 shadow-md lg:top-[189px] top-[200px]  sm:top-[200px] md:top-[198px]"
        onClick={onClick}
      >
            ...
            {newProduct.map((item) => {
              return (
                <div key={item.id} className="px-2">
                  <Link to={item.slux}>
                    <div className="border rounded-lg border-gray-400 flex flex-col p-5 lg:min-h-[418px] sm:min-h-[422px] min-h-[422px] md:min-h-[422px] bg-white ">
